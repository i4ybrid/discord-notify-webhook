...
const fs = require('fs');
const userList = require('./reprocess.json');

const webhookYUrl = 'https://discord.com/api/webhooks/1004377191821361203/LnKmCWtwDHD4rCuYfPvfhUUDz9f3nbzAAc2S_FallgWwLxkUEJc_Ak448cILauK0ZtTa'
const hook = new Webhook(webhookYUrl);
